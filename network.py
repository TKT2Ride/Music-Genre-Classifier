...
class Genre_Model(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv4 = nn.Conv2d(in_channels=6, out_channels=6, kernel_size=5)
        self.bn4 = nn.BatchNorm2d(6)
        # batch * out_channels * 23 * 14
        self.conv5 = nn.Conv2d(in_channels=6, out_channels=16, kernel_size=5)
        self.bn5 = nn.BatchNorm2d(16)

        self.dropout = nn.Dropout()
        # Out channels by the dimensions of the previous layer
        self.fc1 = nn.Linear(16 * 9 * 5, 250)
